...
<head>
    ...
    <link rel="shortcut icon" href="assets/water-drop.png" type="image/x-icon">
...
<body>
    ...
    <div class="main" style="padding: 1vw 5vw; margin-top: 2vw">
        ...
        <div class="buttons">
            <a href="dashboard.php">Energy</a>
            <a href="elec.php">Electricity</a>
            <a href="water.php" class="prime">Water</a>
            <a href="plant.php">Plants</a>
            <a href="waste.php">Waste & Recycling</a>
        </div>
        <div class="container-fluid">
            <h1 style="margin-bottom: 1vw;">Water</h1>
            <p style="padding: 1vw 2vw; text-align: justify; font-size: 1.3vw">
                Dayananda Sagar College is taking significant strides to reduce its water use. The college is
                installing more efficient toilets and fixtures as part of major renovations and new construction, and
                Facilities Management has completed significant work to identify and repair leaks. Water-wise
                landscaping and a major overhaul of the irrigation controls have also led to reductions. The community
                can help the college's water reduction efforts by reporting broken sprinklers to Facilities Management
                at
                <span style="color: #151c49; font-weight: 600;">1234-1234-00</span>.
            </p>
            <div class="dash">
                <div class="img"
                    style="background-color: #27348b; margin-bottom: 2vw; height: 40vh; position: relative;">
                    <img src="https://images.unsplash.com/photo-1598002419716-06326d54493a?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        style="width: 70%; height: 40vh; object-fit: cover;" alt="">
                    <h2 style="position: absolute; top: 20%; right: 2%; color: #fff;">
                        Did you know? <br><br>
                        From 2022 to 2024, the <br> college reduced its outdoor <br> water use by 21%.
                    </h2>
                </div>
                <div class="board" style="margin-top: 4vw;">
                    <iframe title="water2" width="600" height="373.5" style="width: 100%; height: 100vh;"
                        src="https://app.powerbi.com/view?r=eyJrIjoiYTE1YTkzYjYtOGViOS00NTBlLWI4ODctMWVmMzIwZjU0ZmRlIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M2VkN2ZmOTVhMCJ9"

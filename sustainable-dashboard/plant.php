...
<head>
    ...
    <title>Plants | Sustainability</title>
...
<body>
    ...
    <div class="main" style="padding: 2vw 5vw; margin-top: 2vw">
        ...
        <div class="buttons">
            ...
            <a href="plant.php" class="prime">Plants</a>
            <a href="waste.php">Waste & Recycling</a>
        </div>
        <div class="container-fluid">
            <h1 style="margin-bottom: 1vw;">Plants & Greenry</h1>
            <p style="padding: 1vw 2vw; text-align: justify; font-size: 1.3vw">
                At Dayananda Sagar College, a strong emphasis is placed on fostering a green and sustainable
                environment. The college campus is meticulously designed to incorporate abundant greenery, with lush
                gardens, tree-lined pathways, and green spaces spread throughout the campus.

                One notable aspect of the college's approach to greenery is its commitment to maintaining a diverse
                range of plant species. This not only enhances the aesthetic appeal of the campus but also promotes
                biodiversity and ecological balance. The presence of a variety of plant species supports local
                ecosystems by providing habitats for wildlife and contributing to improved air quality.
            </p>
            <div class="dash">
                <div class="img" style="background-color: #27348b; height: 40vh; position: relative;">
                    <img src="https://images.unsplash.com/photo-1667474114761-3ef3a7e92a5a?q=80&w=1771&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        style="width: 70%; height: 40vh; object-fit: cover;" alt="">
                    <h2 style="position: absolute; top: 20%; right: 3%; color: #fff;">
                        Did you know? <br><br>
                        There is a banyan tree <br> which is older then 50 years <br> in our kumaraswamy campus.
                    </h2>
                </div>
                <div class="board" style="margin-top: 2vw;">
                    <iframe title="plants2" width="600" height="373.5" style="width: 100%; height: 100vh;"
                        src="https://app.powerbi.com/view?r=eyJrIjoiODE4M2I3MGMtNmMwMy00YmUxLWFmMzMtODU2OTFjY2U4Yzg2IiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M2VkN2ZmOTVhMCJ9"

...
<head>
    ...
    <link rel="shortcut icon" href="assets/flash.png" type="image/x-icon">
...
<body>
    ...
    <div class="main" style="padding: 2vw 5vw; margin-top: 2vw">
        ...
        <div class="buttons">
            ...
            <a href="elec.php" class="prime">Electricity</a>
            <a href="water.php">Water</a>
            <a href="plant.php">Plants</a>
            <a href="waste.php">Waste & Recycling</a>
        </div>
        <div class="container-fluid">
            <h1 style="margin-bottom: 1vw;">Electricity Use</h1>
            <p style="padding: 1vw 2vw; text-align: justify; font-size: 1.3vw">
                Over the past decade, the college of Dayananda Sagar has reduced its electricity consumption per square
                foot of building space, as well as increased its on-site and off-site renewables totals. Contact the
                Facilities Management Sustainability & Energy division for more information.
            </p>
            <div class="dash">
                <div class="img" style="background-color: #27348b; height: 40vh; position: relative;">
                    <img src="https://images.unsplash.com/photo-1473308822086-710304d7d30c?q=80&w=1931&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        style="width: 70%; height: 40vh; object-fit: cover; object-position: center;" alt="">
                    <h2 style="position: absolute; top: 20%; right: 2%; color: #fff;">
                        Did you know? <br><br>
                        Remaingin 60% of electricity in <br> the college of Dayananda Sagar's <br> electricity comes
                        from BESCOM.
                    </h2>
                </div>
                <div class="board" style="margin-top: 2vw;">
                    <iframe title="elect2" width="600" height="373.5" style="width: 100%; height: 100vh;"
                        src="https://app.powerbi.com/view?r=eyJrIjoiOWYwNDI5OTEtYjNlMS00ZDIwLTg0MTMtOWQzY2M4N2MzNDM1IiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M2VkN2ZmOTVhMCJ9"

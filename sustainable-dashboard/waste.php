...
<head>
    ...
    <link rel="shortcut icon" href="assets/garbage.png" type="image/x-icon">
...
<body>
    ...
    <div class="main" style="padding: 2vw 5vw; margin-top: 2vw">
        ...
        <div class="buttons">
            ...
            <a href="waste.php" class="prime">Waste & Recycling</a>
        </div>
        <div class="container-fluid">
            <h1 style="margin-bottom: 1vw;">Waste & Recycling</h1>
            <p style="padding: 1vw 2vw; text-align: justify; font-size: 1.3vw">
                Recycling and waste are managed by the U's Facilities Management department. Data for main campus is
                reported to the recycling manager. Recycling is important, but the U's recycling team stresses that
                reduction is far more valuable.
            </p>
            <div class="dash">
                <div class="img" style="background-color: #27348b; height: 40vh; position: relative;">
                    <img src="https://images.unsplash.com/photo-1632988663082-4bac2c1847a0?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        style="width: 70%; height: 40vh; object-fit: cover;" alt="">
                    <h2 style="position: absolute; top: 20%; right: 5%; color: #fff;">
                        Did you know? <br><br>
                        In 2022, the U diverted 794 <br> tons of waste from the the <br>landfill through recycling.
                    </h2>
                </div>
                <div class="board" style="margin-top: 2vw;">
                    <iframe title="waste2" width="600" height="373.5" style="width: 100%; height: 100vh;"
                        src="https://app.powerbi.com/view?r=eyJrIjoiYmQwYTE5NDktMDczMS00MWIwLWIyNjYtOWRhZTI5MDM2MTUwIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M2VkN2ZmOTVhMCJ9"
